        ...
        <div className="bg-white shadow-sm p-3 rounded flex-1">
          <div className="flex flex-row mb-3 justify-between">
            ...
            <div className="flex gap-2">
              ...
              <div className="border border-[#cccccc] bg-white rounded-md py-2 px-3 flex items-center cursor-pointer">
                {DownloadSVG}
              </div>
            </div>
          </div>
            ...
            {[
              ...
              if (x === "10") {
                return (
                  <div
                    key={ind}
                    className="w-[35px] h-[35px] justify-center items-center flex bg-blue-600 text-white rounded cursor-pointer"
                  >
                    {x}
                  </div>
                );
                ...
                return (
                  <div key={ind} className="p-2 cursor-pointer">
                    {x}
                  </div>
                );
              }
